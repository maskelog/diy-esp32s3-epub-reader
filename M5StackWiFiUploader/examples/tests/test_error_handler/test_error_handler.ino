...
void testLogError() {
    ...
    errorHandler.logError(M5SWU_ERR_TIMEOUT, "Connection timeout", "test.jpg", 1024);
...
void testRecoverableErrors() {
    ...
    TestCase cases[] = {
        {M5SWU_ERR_TIMEOUT, true, "M5SWU_ERR_TIMEOUT"},
...
void testErrorCallback() {
    ...
    errorHandler.logError(M5SWU_ERR_TIMEOUT, "Test callback", "callback.txt", 512);
